...
## Alıştırmalar
Aşağıdaki türdeki ifade ifadelerini belirleyin:
...
* **Artırma deyimi (increment statement)**
* **Metot çağırma deyimi (method invocation statement)**
* **Nesne oluşturma deyimi (object creation statement)**
