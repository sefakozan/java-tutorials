...
# 2. Nesne Yönelimli Programlamanın Avantajları

Kodu bağımsız yazılım nesneleri halinde paketlemek bir dizi avantaj sağlar:

1. **Modülerlik (Modularity):** Bir nesnenin kaynak kodu, diğer nesnelerin kaynak kodundan bağımsız olarak yazılabilir ve sürdürülebilir. Bir nesne oluşturulduktan sonra sistem içinde kolayca elden ele dolaştırılabilir.
