...
Java platformu, güvenliği temel bir tasarım hedefi olarak ele alır ve çok katmanlı koruma mekanizmaları sağlar.
...
### 3. [İzinler ve Güvenlik Politikaları (Permissions & java.policy)](ileri-duzey/security/policy.md)
Kod kaynağı (`codeBase`), imzalayan (`signedBy`) ve izin kurallarının yapılandırılması.
